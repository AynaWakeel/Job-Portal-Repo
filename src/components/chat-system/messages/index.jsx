...
//                                                             <img src={msg.pic[0]} alt="chat-img" className="chat-img"  onClick={() => OpenGallery(msg.pic, 0)} />

//                                                             {msg.pic.length > 1 && (
//                                                                 <div className="pic-overlay"  onClick={() => OpenGallery(msg.pic, 0)}>+{msg.pic.length - 1}</div>
//                                                             )}
//                                                         </div>
//                                                     )}
...
//                             <img src={DownloadPic} alt="download" className="download-icon" />
//                             <img src={close} alt="close" className="close-icon" onClick={CloseGallery} />
//                         </div>
